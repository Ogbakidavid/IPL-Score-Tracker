...
function Stat() {
    const stats = [
        ...
        { icon: Trophy, title: "Teams", value: "20" },
        { icon: Calendar, title: "Tournament Duration", value: "100 days" },
        { icon: TrendingUp, title: "Highest Score", value: "256/7" },
    ];

    return (
        <div className="py-16 bg-gradient-to-r from-blue-600 to-blue-900 text-white">
